...
document.addEventListener("DOMContentLoaded", function(e) {
    {
        ...
        var l, s = document.querySelector('[name="formValidationDob"]');
        s && s.flatpickr({
            enableTime: !1,
            dateFormat: "Y/m/d",
            onChange: function() {
        ...
        a.length && (a.wrap('<div class="position-relative"></div>'),
        a.select2({
        ...
        isRtl && (s = [].slice.call(document.querySelectorAll(".typeahead"))) && s.forEach(e => {
        ...
        t.typeahead({
            ...
            name: "tech",
            source: (l = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"],
            function(e, a) {
                var t = []
                  , o = new RegExp(e,"i");
                $.each(l, function(e, a) {
