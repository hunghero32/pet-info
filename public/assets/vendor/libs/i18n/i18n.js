! function(e, t) {
    ...
    return function() {
        ...
        o = Object.getPrototypeOf ? function(e) {
            ...
            t = t || [null, o({}), o([]), o(o)];
            for (var a = 2 & n && e;
                "object" == typeof a && !~t.indexOf(a); a = o(a)) Object.getOwnPropertyNames(a).forEach((function(t) {
                r[t] = function() {
                    return e[t]
                }
            }));
        ...
        return function() {
            ...
            const e = e => "string" == typeof e,
                ...
                c = (e, t, o) => {
                    ...
                    let i = t[t.length - 1],
                        ...
                        a = l(e, r, Object);
                    for (; void 0 === a.obj && r.length;) i = `${r[r.length-1]}.${i}`, r = r.slice(0, r.length - 1), a = l(e, r, Object), a ? .obj && void 0 !== a.obj[`${a.k}.${i}`] && (a.obj = void 0);
                    a.obj[`${a.k}.${i}`] = o
                },
                u = (e, t) => {
                    const {
                ...
                h = (t, o, n) => {
                    for (const s in o) "__proto__" !== s && "constructor" !== s && (s in t ? e(t[s]) || t[s] instanceof String || e(o[s]) || o[s] instanceof String ? n && (t[s] = o[s]) : h(t[s], o[s], n) : t[s] = o[s]);
                    return t
                },
                p = e => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
            var d = {
            ...
            class k extends w {
                ...
                getResource(t, o, n) {
                    ...
                    let a;
                    t.indexOf(".") > -1 ? a = t.split(".") : (a = [t, o], n && (Array.isArray(n) ? a.push(...n) : e(n) && i ? a.push(...n.split(i)) : a.push(n)));
                    const l = u(this.data, a);
                    return !l && !o && !n && t.indexOf(".") > -1 && (t = a[0], o = a[1], n = a.slice(2).join(".")), !l && r && e(n) ? y(this.data ? .[t] ? .[o], n, i) : l
                }
                addResource(e, t, o, n) {
                    ...
                    const i = void 0 !== s.keySeparator ? s.keySeparator : this.options.keySeparator;
                    let r = [e, t];
                    o && (r = r.concat(i ? o.split(i) : o)), e.indexOf(".") > -1 && (r = e.split("."), n = t, t = r[1]), this.addNamespaces(t), c(this.data, r, n), s.silent || this.emit("added", e, t, o, n)
                }
                addResources(t, o, n) {
                    let s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {
                        silent: !1
                    };
                    for (const s in n)(e(n[s]) || Array.isArray(n[s])) && this.addResource(t, o, s, n[s], {
                        silent: !0
                    });
                ...
                addResourceBundle(e, t, o, n, s) {
                    ...
                    let a = u(this.data, r) || {};
                    i.skipCopy || (o = JSON.parse(JSON.stringify(o))), n ? h(a, o, s) : a = { ...a,
                        ...o
                    }, c(this.data, r, a), i.silent || this.emit("added", e, t, o)
                }
            ...
            class P extends w {
                ...
                translate(t, o, n) {
                    if ("object" != typeof o && this.options.overloadTranslationOptionHandler && (o = this.options.overloadTranslationOptionHandler(arguments)), "object" == typeof o && (o = { ...o
                        }), o || (o = {}), null == t) return "";
                    ...
                    const s = void 0 !== o.returnDetails ? o.returnDetails : this.options.returnDetails,
                        i = void 0 !== o.keySeparator ? o.keySeparator : this.options.keySeparator,
                        {
                            key: r,
                            namespaces: a
                        } = this.extractFromKey(t[t.length - 1], o),
                        l = a[a.length - 1],
                    ...
                    if (!(y && p && v && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(f) < 0) || e(m) && Array.isArray(p))
                        if (y && e(m) && Array.isArray(p)) p = p.join(m), p && (p = this.extendTranslation(p, t, o, n));
                            ...
                            if (a || s || b) {
                                ...
                                else "all" === this.options.saveMissingTo ? e = this.languageUtils.toResolveHierarchy(o.lng || this.language) : e.push(o.lng || this.language);
                                const n = (e, t, n) => {
                                    const s = d && n !== p ? n : v;
                                    this.options.missingKeyHandler ? this.options.missingKeyHandler(e, l, t, s, b, o) : this.backendConnector ? .saveMissing && this.backendConnector.saveMissing(e, l, t, s, b, o), this.emit("missingKey", e, l, t, p)
                                };
                                this.options.saveMissing && (this.options.saveMissingPlurals && u ? e.forEach((e => {
                                    const t = this.pluralResolver.getSuffixes(e, o);
                                    m && o[`defaultValue${this.options.pluralSeparator}zero`] && t.indexOf(`${this.options.pluralSeparator}zero`) < 0 && t.push(`${this.options.pluralSeparator}zero`), t.forEach((t => {
                                        n([e], r + t, o[`defaultValue${t}`] || y)
                                    }))
                                })) : n(e, r, y))
                            }
                            p = this.extendTranslation(p, t, o, h, n), a && p === r && this.options.appendNamespaceToMissingKey && (p = `${l}:${r}`), (a || s) && this.options.parseMissingKeyHandler && (p = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${l}:${r}` : r, s ? p : void 0))
                        }
                    else {
                        if (!o.returnObjects && !this.options.returnObjects) {
                            this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
                            const e = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(d, p, { ...o,
                                ns: a
                ...
                extendTranslation(t, o, n, s, i) {
                    var r = this;
                    if (this.i18nFormat ? .parse) t = this.i18nFormat.parse(t, { ...this.options.interpolation.defaultVariables,
                        ...n
                        ...
                        if (this.options.interpolation.defaultVariables && (c = { ...this.options.interpolation.defaultVariables,
                                ...c
                            }), t = this.interpolator.interpolate(t, c, n.lng || this.language || s.usedLng, n), a) {
                            const e = t.match(this.interpolator.nestingRegexp);
                            l < (e && e.length) && (n.nest = !1)
                        }!n.lng && s && s.res && (n.lng = this.language || s.usedLng), !1 !== n.nest && (t = this.interpolator.nest(t, (function() {
                            for (var e = arguments.length, t = new Array(e), s = 0; s < e; s++) t[s] = arguments[s];
                            return i ? .[0] !== t[0] || n.context ? r.translate(...t, o) : (r.logger.warn(`It seems you are nesting recursively key: ${t[0]} in key: ${o[0]}`), null)
                        ...
                        u.forEach((e => {
                            this.isValidLookup(o) || (r = e, L[`${g[0]}-${e}`] || !this.utils ? .hasLoadedNamespace || this.utils ? .hasLoadedNamespace(r) || (L[`${g[0]}-${e}`] = !0, this.logger.warn(`key "${n}" for languages "${g.join(", ")}" won't get resolved as namespace "${r}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), g.forEach((t => {
                                ...
                                if (this.i18nFormat ? .addLookupKeys) this.i18nFormat.addLookupKeys(n, c, t, e, a);
                                    ...
                                    if (h && (n.push(c + e), a.ordinal && 0 === e.indexOf(s) && n.push(c + e.replace(s, this.options.pluralSeparator)), p && n.push(c + o)), d) {
                                        const t = `${c}${this.options.contextSeparator}${a.context}`;
                                        n.push(t), h && (n.push(t + e), a.ordinal && 0 === e.indexOf(s) && n.push(t + e.replace(s, this.options.pluralSeparator)), p && n.push(t + o))
                                    }
                                }
                                let r;
                ...
                getUsedParamsDetails() {
                    ...
                    let s = n ? t.replace : t;
                    if (n && void 0 !== t.count && (s.count = t.count), this.options.interpolation.defaultVariables && (s = { ...this.options.interpolation.defaultVariables,
                            ...s
                        }), !n) {
                        s = { ...s
                        };
            ...
            class j {
                ...
                getFallbackCodes(t, o) {
                    ...
                    let n = t[o];
                    return n || (n = t[this.getScriptPartFromCode(o)]), n || (n = t[this.formatLanguageCode(o)]), n || (n = t[this.getLanguagePartFromCode(o)]), n || (n = t.default), n || []
                }
                toResolveHierarchy(t, o) {
                    ...
                    return e(t) && (t.indexOf("-") > -1 || t.indexOf("_") > -1) ? ("languageOnly" !== this.options.load && i(this.formatLanguageCode(t)), "languageOnly" !== this.options.load && "currentOnly" !== this.options.load && i(this.getScriptPartFromCode(t)), "currentOnly" !== this.options.load && i(this.getLanguagePartFromCode(t))) : e(t) && i(this.formatLanguageCode(t)), n.forEach((e => {
            ...
            class $ {
                constructor(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.languageUtils = e, this.options = t, this.logger = S.create("pluralResolver"), this.pluralRulesCache = {}
                }
                addRule(e, t) {
                    this.rules[e] = t
                }
                ...
                getSuffixes(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        o = this.getRule(e, t);
                    return o || (o = this.getRule("dev", t)), o ? o.resolvedOptions().pluralCategories.sort(((e, t) => R[e] - R[t])).map((e => `${this.options.prepend}${t.ordinal?`ordinal${this.options.prepend}`:""}${e}`)) : []
                }
                getSuffix(e, t) {
                    let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                    const n = this.getRule(e, o);
                    return n ? `${this.options.prepend}${o.ordinal?`ordinal${this.options.prepend}`:""}${n.select(t)}` : (this.logger.warn(`no plural rule found for: ${e}`), this.getSuffix("dev", t, o))
                }
            }
            ...
            class D {
                constructor() {
                    ...
                    this.logger = S.create("interpolator"), this.options = e, this.format = e ? .interpolation ? .format || (e => e), this.init(e)
                }
                init() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    ...
                    this.escape = void 0 !== t ? t : g, this.escapeValue = void 0 === o || o, this.useRawValueToEscape = void 0 !== n && n, this.prefix = s ? p(s) : i || "{{", this.suffix = r ? p(r) : a || "}}", this.formatSeparator = l || ",", this.unescapePrefix = c ? "" : u || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = h ? p(h) : d || p("$t("), this.nestingSuffix = f ? p(f) : m || p(")"), this.nestingOptionsSeparator = y || ",", this.maxReplaces = v || 1e3, this.alwaysFormat = void 0 !== b && b, this.resetRegExp()
                }
                reset() {
                ...
                interpolate(t, n, s, i) {
                    ...
                    const c = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {},
                        u = e => {
                            if (e.indexOf(this.formatSeparator) < 0) {
                                ...
                                return this.alwaysFormat ? this.format(t, void 0, s, { ...i,
                                    ...n,
                                    interpolationkey: e
                                }) : t
                            }
                            ...
                            return this.format(N(n, c, o, this.options.keySeparator, this.options.ignoreJSONStructure), r, s, { ...i,
                                ...n,
                                interpolationkey: o
                            })
                        };
                    ...
                    return [{
                        ...
                        for (l = 0; r = n.regex.exec(t);) {
                            ...
                            if (t = t.replace(r[0], c), p ? (n.regex.lastIndex += a.length, n.regex.lastIndex -= r[0].length) : n.regex.lastIndex = 0, l++, l >= this.maxReplaces) break
                        }
                    })), t
                }
                nest(t, n) {
                    ...
                    for (; s = this.nestingRegexp.exec(t);) {
                        let c = [];
                        r = { ...a
                        }, r = r.replace && !e(r.replace) ? r.replace : r, r.applyPostProcessor = !1, delete r.defaultValue;
                        let u = !1;
                        ...
                        e(i) || (i = o(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${t}`), i = ""), u && (i = c.reduce(((e, t) => this.format(e, t, a.lng, { ...a,
            ...
            const T = e => {
                ...
                return (o, n, s) => {
                    let i = s;
                    s && s.interpolationkey && s.formatParams && s.formatParams[s.interpolationkey] && s[s.interpolationkey] && (i = { ...i,
                        ...
                        const {
                            ...
                            if (e.indexOf("(") > -1) {
                                ...
                                "currency" === t && s.indexOf(":") < 0 ? o.currency || (o.currency = s.trim()) : "relativetime" === t && s.indexOf(":") < 0 ? o.range || (o.range = s.trim()) : s.split(";").forEach((e => {
                                    if (e) {
                                        const [t, ...n] = e.split(":"), s = n.join(":").trim().replace(/^'+|'+$/g, ""), i = t.trim();
                                        o[i] || (o[i] = s), "false" === s && (o[i] = !1), "true" === s && (o[i] = !0), isNaN(s) || (o[i] = parseInt(s, 10))
                                    }
                                }))
                            }
                            return {
            ...
            class I extends w {
                ...
                queueLoad(e, t, o, n) {
                    ...
                    return e.forEach((e => {
                        ...
                        t.forEach((t => {
                            const r = `${e}|${t}`;
                            !o.reload && this.store.hasResourceBundle(e, t) ? this.state[r] = 2 : this.state[r] < 0 || (1 === this.state[r] ? void 0 === i[r] && (i[r] = !0) : (this.state[r] = 1, n = !1, void 0 === i[r] && (i[r] = !0), void 0 === s[r] && (s[r] = !0), void 0 === a[t] && (a[t] = !0)))
                        })), n || (r[e] = !0)
                ...
                loaded(e, t, o) {
                    ...
                    this.queue.forEach((o => {
                        ...
                        })(o, e), t && o.errors.push(t), 0 !== o.pendingCount || o.done || (Object.keys(o.loaded).forEach((e => {
                            r[e] || (r[e] = {});
                            const t = o.loaded[e];
                ...
                loadOne(e) {
                    ...
                    this.read(n, s, "read", void 0, void 0, ((o, i) => {
                        o && this.logger.warn(`${t}loading namespace ${s} for language ${n} failed`, o), !o && i && this.logger.log(`${t}loaded namespace ${s} for language ${n}`, i), this.loaded(e, o, i)
                    }))
                }
                saveMissing(e, t, o, n, s) {
                    ...
                    if (!this.services ? .utils ? .hasLoadedNamespace || this.services ? .utils ? .hasLoadedNamespace(t)) {
                        if (null != o && "" !== o) {
                            if (this.backend ? .create) {
                                ...
                                if (l.length < 6) try {
                                    let s;
                                    s = 5 === l.length ? l(e, t, o, n, a) : l(e, t, o, n), s && "function" == typeof s.then ? s.then((e => r(null, e))).catch(r) : r(null, s)
                                } catch (e) {
                                    r(e)
                                } else l(e, t, o, n, r, a)
                            }
                    ...
                    } else this.logger.warn(`did not save key "${o}" as the namespace "${t}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")
                }
            }
            const A = () => ({
                    debug: !1,
                    ...
                    overloadTranslationOptionHandler: t => {
                        let o = {};
                        if ("object" == typeof t[1] && (o = t[1]), e(t[1]) && (o.defaultValue = t[1]), e(t[2]) && (o.tDescription = t[2]), "object" == typeof t[2] || "object" == typeof t[3]) {
                            const e = t[3] || t[2];
                ...
                U = t => (e(t.ns) && (t.ns = [t.ns]), e(t.fallbackLng) && (t.fallbackLng = [t.fallbackLng]), e(t.fallbackNS) && (t.fallbackNS = [t.fallbackNS]), t.supportedLngs ? .indexOf ? .("cimode") < 0 && (t.supportedLngs = t.supportedLngs.concat(["cimode"])), "boolean" == typeof t.initImmediate && (t.initAsync = t.initImmediate), t),
                M = () => {};
            class V extends w {
                constructor() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    var o;
                    if (super(), this.options = U(e), this.services = {}, this.logger = S, this.modules = {
                            external: []
                        }, o = this, Object.getOwnPropertyNames(Object.getPrototypeOf(o)).forEach((e => {
                ...
                init() {
                    ...
                    this.isInitializing = !0, "function" == typeof n && (s = n, n = {}), !n.defaultNS && !1 !== n.defaultNS && n.ns && (e(n.ns) ? n.defaultNS = n.ns : n.ns.indexOf("translation") < 0 && (n.defaultNS = n.ns[0]));
                    const i = A();
                    this.options = { ...i,
                        ...this.options,
                        ...U(n)
                    ...
                    }, void 0 !== n.keySeparator && (this.options.userDefinedKeySeparator = n.keySeparator), void 0 !== n.nsSeparator && (this.options.userDefinedNsSeparator = n.nsSeparator);
                    const r = e => e ? "function" == typeof e ? new e : e : null;
                    if (!this.options.isClone) {
                        let e;
                        this.modules.logger ? S.init(r(this.modules.logger), this.options) : S.init(null, this.options), e = this.modules.formatter ? this.modules.formatter : F;
                        const t = new j(this.options);
                        this.store = new k(this.options.resources, this.options);
                        const n = this.services;
                        n.logger = S, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new $(t, {
                            prepend: this.options.pluralSeparator,
                            simplifyPluralSuffix: this.options.simplifyPluralSuffix
                        }), !e || this.options.interpolation.format && this.options.interpolation.format !== i.interpolation.format || (n.formatter = r(e), n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new D(this.options), n.utils = {
                            hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                        }, n.backendConnector = new I(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (function(e) {
                    ...
                    const a = t(),
                        l = () => {
                            const e = (e, t) => {
                                this.isInitializing = !1, this.isInitialized && !this.initializedStoreOnce && this.logger.warn("init: i18next is already initialized. You should call init just once!"), this.isInitialized = !0, this.options.isClone || this.logger.log("initialized", this.options), this.emit("initialized", this.options), a.resolve(t), s(e, t)
                            };
                ...
                reloadResources(e, o, n) {
                    const s = t();
                    return "function" == typeof e && (n = e, e = void 0), "function" == typeof o && (n = o, o = void 0), e || (e = this.languages), o || (o = this.options.ns), n || (n = M), this.services.backendConnector.reload(e, o, (e => {
                        s.resolve(), n(e)
                    })), s
                }
                use(e) {
                    ...
                    return "backend" === e.type && (this.modules.backend = e), ("logger" === e.type || e.log && e.warn && e.error) && (this.modules.logger = e), "languageDetector" === e.type && (this.modules.languageDetector = e), "i18nFormat" === e.type && (this.modules.i18nFormat = e), "postProcessor" === e.type && O.addPostProcessor(e), "formatter" === e.type && (this.modules.formatter = e), "3rdParty" === e.type && this.modules.external.push(e), this
                }
                ...
                changeLanguage(o, n) {
                    ...
                    const r = e => {
                        ...
                        a = (e, t) => {
                            t ? (r(t), this.translator.changeLanguage(t), this.isLanguageChangingTo = void 0, this.emit("languageChanged", t), this.logger.log("languageChanged", t)) : this.isLanguageChangingTo = void 0, i.resolve((function() {
                        ...
                        l = t => {
                            ...
                            n && (this.language || r(n), this.translator.language || this.translator.changeLanguage(n), this.services.languageDetector ? .cacheUserLanguage ? .(n)), this.loadResources(n, (e => {
                                a(e, n)
                            }))
                        };
                ...
                getFixedT(t, o, n) {
                    ...
                    const i = function(e, t) {
                        ...
                        let u;
                        return u = o.keyPrefix && Array.isArray(e) ? e.map((e => `${o.keyPrefix}${c}${e}`)) : o.keyPrefix ? `${o.keyPrefix}${c}${e}` : e, s.t(u, o)
                    };
                ...
                loadNamespaces(o, n) {
                    const s = t();
                    return this.options.ns ? (e(o) && (o = [o]), o.forEach((e => {
                        this.options.ns.indexOf(e) < 0 && this.options.ns.push(e)
                ...
                cloneInstance() {
                    ...
                    if (["store", "services", "language"].forEach((e => {
                        ...
                        }, Object.keys(e[t]).reduce(((o, n) => (o[n] = { ...e[t][n]
                        }, o)), {}))), {});
                        s.store = new k(e, n), s.services.resourceStore = s.store
                    }
                    return s.translator = new P(s.services, n), s.translator.on("*", (function(e) {
                        for (var t = arguments.length, o = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++) o[n - 1] = arguments[n];
                        s.emit(e, ...o)
            ...
            H.createInstance, H.dir, H.init, H.loadResources, H.reloadResources, H.use, H.changeLanguage, H.getFixedT, H.t, H.exists, H.setDefaultNamespace, H.hasLoadedNamespace, H.loadNamespaces, H.loadLanguages;
            ...
            var G = function(e, t) {
                ...
                Z = !1,
                ee = function(e, t, o, n) {
                    return "function" == typeof o && (n = o, o = void 0), n = n || function() {}, K && 0 !== t.indexOf("file:") ? function(e, t, o, n) {
                        e.queryStringParams && (t = G(t, e.queryStringParams));
                        var s = X({}, "function" == typeof e.customHeaders ? e.customHeaders() : e.customHeaders);
                        "undefined" == typeof window && "undefined" != typeof global && void 0 !== global.process && global.process.versions && global.process.versions.node && (s["User-Agent"] = "i18next-http-backend (node/".concat(global.process.version, "; ").concat(global.process.platform, " ").concat(global.process.arch, ")")), o && (s["Content-Type"] = "application/json");
                        ...
                        try {
                            ...
                            if (!i || 0 === Object.keys(i).length || !e.message || e.message.indexOf("not implemented") < 0) return n(e);
                            try {
                        ...
                        o && "object" === Q(o) && (o = G("", o).slice(1)), e.queryStringParams && (t = G(t, e.queryStringParams));
                        try {
                            var s = z ? new z : new B("MSXML2.XMLHTTP.3.0");
                            s.open(o ? "POST" : "GET", t, 1), e.crossDomain || s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), s.withCredentials = !!e.withCredentials, o && s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), s.overrideMimeType && s.overrideMimeType("application/json");
            ...
            var ae = function(e, t, o) {
                return t && se(e.prototype, t), o && se(e, o), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), e
            }((function e(t) {
                ...
                }(this, e), this.services = t, this.options = o, this.allOptions = n, this.type = "backend", this.init(t, o, n)
            }), [{
                key: "init",
                value: function(e) {
                    var t = this,
                        ...
                        n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                    if (this.services = e, this.options = ne(ne(ne({}, {
                        ...
                        }), this.options || {}), o), this.allOptions = n, this.services && this.options.reloadInterval) {
                ...
                value: function(e, t, o, n, s) {
                    ...
                    "function" == typeof this.options.loadPath && (a = this.options.loadPath(e, o)), (a = function(e) {
                ...
                value: function() {
                    ...
                    if (!i || "cimode" !== i.toLowerCase()) {
                        ...
                        a(i), this.allOptions.preload && this.allOptions.preload.forEach((function(e) {
                            return a(e)
                        })), r.forEach((function(t) {
                            e.allOptions.ns.forEach((function(e) {
                                o.read(t, e, "read", null, null, (function(n, i) {
                                    n && s.warn("loading namespace ".concat(e, " for language ").concat(t, " failed"), n), !n && i && s.log("loaded namespace ".concat(e, " for language ").concat(t), i), o.loaded("".concat(t, "|").concat(e), n, i)
                                }))
                            }))
                        }))
                    }
            ...
            const he = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
                pe = {
                    create(e, t, o, n) {
                        ...
                        o && (s.expires = new Date, s.expires.setTime(s.expires.getTime() + 60 * o * 1e3)), n && (s.domain = n), document.cookie = function(e, t) {
                            ...
                            if (o.httpOnly && (n += "; HttpOnly"), o.secure && (n += "; Secure"), o.sameSite) switch ("string" == typeof o.sameSite ? o.sameSite.toLowerCase() : o.sameSite) {
                                case !0:
                                    n += "; SameSite=Strict";
                                    break;
                                case "lax":
            ...
            class je {
                ...
                init() {
                    ...
                    this.services = e, this.options = function(e) {
                        return ue.call(ce.call(arguments, 1), (t => {
                            if (t)
                                for (const o in t) void 0 === e[o] && (e[o] = t[o])
                        })), e
                    }(t, this.options || {}, {
                        order: Pe,
                ...
                detect() {
                    ...
                    })), t = t.map((e => this.options.convertDetectedLanguage(e))), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null
                }
                cacheUserLanguage(e) {
